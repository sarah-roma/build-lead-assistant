...
from mural_extraction import list_mural_widgets, get_widget_text

@pytest.fixture
def mock_request():
    with patch("mural_extraction.requests.request") as mock_request:
        yield mock_request
...
@pytest.fixture
def mock_list():
    with patch("mural_extraction.list_mural_widgets") as mock_list:
        yield mock_list
